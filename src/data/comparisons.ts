...
export const comparisonHubs: ComparisonHub[] = [
  ...
  },
  {
    ...
    hook:
      "Most LinkedIn tools help you write faster — but you still face the blank page. Crucible skips the editor entirely: an AI interviewer captures your spoken insights and turns one recording into written posts, video clips, and deep dives in your own voice.",
    audience:
      "Built for founders, consultants, and creators who want LinkedIn authority plus video and written content across channels.",
    spokes: [
  ...
  },
  {
    ...
    hook:
      "Agencies charge thousands a month and take days to turn drafts. Crucible interviews you like an agency would — then delivers the week's clips, posts, and deep dives instantly, for a fraction of the cost.",
    audience:
...
export const comparisons: Comparison[] = [
  {
    ...
    description:
      "Taja AI repurposes and auto-schedules existing long-form video. Crucible interviews you first, then generates clips, written posts, and deep dives.",
    pitch:
      "Taja AI optimizes, repurposes, and auto-schedules existing long-form video content for social channels. Crucible acts as an end-to-end content engine that interviews you first, then generates clips, written social posts, and long-form deep dives.",
    rows: [
      { dimension: "Core job", crucible: "Raw brain dump → a week of video & written content", rival: "Long-form video → repurposed clips & auto-scheduled posts" },
  ...
  },
  {
    ...
    rows: [
      { dimension: "Core job", crucible: "Raw brain dump → video clips + deep dives + written posts", rival: "AI brand voice scaling & team content deployment" },
    ...
    faqs: [
      ...
      { q: "Does Crucible distribute content to every channel?", a: "Crucible produces the assets — clips, deep dives, and written posts — and publishes directly to LinkedIn. For other channels, download the files and post them wherever you like." },
    ],
  },
  {
    slug: "draft-ai",
    ...
    pitch:
      "DraftAI transforms brief voice notes into short social media text posts and video scripts. Crucible processes raw audio into complete multi-media campaigns containing video clips, deep-dive articles, and structured social posts.",
    rows: [
      { dimension: "Core job", crucible: "Raw brain dump → clips + deep dives + written posts", rival: "Voice notes → social text posts & script drafts" },
    ...
    faqs: [
      { q: "Is DraftAI cheaper than Crucible?", a: "DraftAI is $14.99/month for text posts and scripts from voice notes. Crucible starts at $49/month but delivers publish-ready video clips and deep dives — not just text drafts." },
      { q: "Can I record with my phone?", a: "Yes. Record in-app or upload video or audio from your device — Crucible processes either." },
      { q: "Does Crucible write scripts?", a: "Crucible produces finished videos and written posts. Scripting is an intermediate step the system handles for you, so you never face a blank script document." },
    ],
  },
  {
    slug: "vidgenie",
    ...
    rows: [
      ...
      { dimension: "Written outputs", crucible: "Full LinkedIn posts, newsletters, and long-form articles", rival: "Video scripts only" },
    ...
    faqs: [
      ...
      { q: "What if I don't want to be on camera?", a: "Record a raw audio brain dump or an audio-only interview. Crucible works from your spoken words and can produce written posts and deep dives without video." },
      { q: "How fast is content generated?", a: "A few minutes after recording, typically. Your edited video, clips, and written posts come back ready to review." },
    ],
  },
  {
    slug: "storyshort",
    ...
    differentiators: [
      ...
      { title: "Channel coverage", body: "StoryShort is limited to short vertical video platforms. Crucible delivers video clips alongside written essays, newsletters, and text posts." },
    ],
    faqs: [
  ...
  },
  {
    ...
    description:
      "Oiti AI generates written LinkedIn posts optimized for dwell time. Crucible captures spoken audio to produce video clips and written content across channels.",
    pitch:
      "Oiti AI is an AI personal branding tool designed to generate written LinkedIn posts tailored to maximize dwell time. Crucible captures rich spoken audio to generate both written LinkedIn content and ready-to-publish video clips.",
    rows: [
      { dimension: "Core job", crucible: "Raw brain dump → video clips + written posts", rival: "Written LinkedIn post generation & dwell time optimization" },
      { dimension: "Media support", crucible: "Video clips, audio processing, and written posts", rival: "Written posts and infographics" },
    ...
    differentiators: [
      { title: "Audio/video native", body: "Oiti AI focuses on text generation and infographic tools. Crucible captures native video, yielding clips alongside text posts." },
    ...
    faqs: [
      { q: "Is Crucible a LinkedIn writing tool?", a: "LinkedIn writing is one output. Crucible also produces video clips, deep dives, and newsletters from the same recording — LinkedIn is a destination, not the whole system." },
  ...
  },
  {
    ...
    differentiators: [
      ...
      { title: "Cross-format production", body: "Supergrow focuses strictly on text posts and LinkedIn formatting. Crucible creates short clips, long-form videos, newsletters, and articles simultaneously." },
    ...
    faqs: [
      { q: "Does Supergrow do what Crucible does?", a: "Supergrow is a text editor and scheduler for LinkedIn. Crucible generates video and written content from your spoken insights — it's an upstream creation engine, not an editor." },
      { q: "I write my own posts — why would I use Crucible?", a: "For the video side and the interview. Talk for ten minutes and get clips, deep dives, and written drafts — then hand them to your favorite editor if you want." },
  ...
  },
  {
    ...
    rows: [
      ...
      { dimension: "Deliverables", crucible: "Video clips, deep dives, newsletters, social posts", rival: "Customized online authority infrastructure & media placement" },
  ...
  },
  {
    ...
    rows: [
      ...
      { dimension: "Outputs", crucible: "Clips + deep dives + written posts", rival: "Polished video/audio & transcripts" },
    ...
    differentiators: [
      ...
      { title: "Multi-format campaigns", body: "Descript outputs media files. Crucible turns one recording into a full week of written LinkedIn posts, newsletters, and video clips." },
    ...
    faqs: [
      ...
      { q: "Can I bring my Descript workflows to Crucible?", a: "If you already record podcasts or videos, upload them to Crucible and it will process them into clips and written posts with your brand voice profile." },
  ...
  },
  {
    ...
    description:
      "Submagic styles short-form videos with flashy captions and B-roll. Crucible builds the narrative from your raw thoughts and outputs both video and written content.",
    pitch:
      "Submagic styles short-form videos with flashy captions and B-roll. Crucible builds the narrative from your raw thoughts and outputs both video and written content.",
    rows: [
      ...
      { dimension: "Outputs", crucible: "Clips + deep dives + written posts", rival: "Vertical short-form clips only" },
  ...
  },
  {
    ...
    rows: [
      ...
      { dimension: "Outputs", crucible: "Clips + deep dives + written posts", rival: "Highly polished talking-head clips" },
    ...
    differentiators: [
      ...
      { title: "One pass, every format", body: "Captions ends at video render. Crucible gives you the accompanying deep dives and written social posts automatically." },
    ],
    faqs: [
  ...
  },
  {
    ...
    rows: [
      ...
      { dimension: "Outputs", crucible: "Clips + deep dives + written posts", rival: "Video files and subtitles" },
